...
type Config struct {
	...
	WebsocketSslBind []string `goconf:"base:websocket.sslbind:,"`
	WebsocketSslCrt  string   `goconf:"base:websocket.sslcrt"`
	WebsocketSslKey  string   `goconf:"base:websocket.sslkey"`
...
func InitConfig() error {
	Conf = &Config{
		...
		WebsocketSslBind: []string{"localhost:9096"},
		WebsocketSslCrt:  "",
		WebsocketSslKey:  "",
